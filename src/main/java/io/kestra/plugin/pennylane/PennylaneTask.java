    ...
    examples = {
        @io.kestra.core.models.annotations.Example(
            ...
            code = """
                ...
                tasks:
                  - id: reverse
                    type: io.kestra.plugin.pennylane.PennylaneTask
                    format: "Text to be reverted"
                """
        )
    }
)
public class PennylaneTask extends Task implements RunnableTask<PennylaneTask.Output> {
    @Schema(
    ...
    @Override
    public PennylaneTask.Output run(RunContext runContext) throws Exception {
